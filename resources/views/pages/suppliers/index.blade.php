                ...
                <div
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center gap-2 md:gap-4 me-2">
                            ...
                            @include('pages.suppliers.utils.modal-add')
                        ...
                        <!-- Kanan: Search -->
                        <form action="{{ route('supplier.index') }}" method="GET" class="flex items-center max-w-sm">
                    ...
                    <div class="md:my-4 flex justify-center" id="suppliersTable">
                        {{ $suppliers->links() }}
                    </div>
                </div>
            </div>
