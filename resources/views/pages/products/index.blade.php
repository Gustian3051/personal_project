    ...
    <div class="p-1 sm:ml-64 dark:bg-gray-900">
        <div class="container">
            <div class="p-4 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-7">
                <div class=" mb-4">
                    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Product</h1>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center gap-2 md:gap-4 me-2">
                            ...
                            @include('pages.products.utils.modal-add')
                        ...
                        <!-- Kanan: Search -->
                        <form action="{{ route('product.index') }}" method="GET" class="flex items-center max-w-sm">
                    ...
                    <div class="md:my-4 flex justify-center" id="productsTable">
                        {{ $products->links() }}
                    </div>
                </div>
            </div>
