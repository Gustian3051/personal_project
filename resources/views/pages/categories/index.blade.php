    ...
    <div class="p-1 sm:ml-64 dark:bg-gray-900">
        <div class="container">
            <div class="p-4 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-7">
                <div class=" mb-4">
                    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Kategori</h1>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center gap-2 md:gap-4 me-2">
                            ...
                            @include('pages.categories.utils.modal-add')
                        ...
                        <!-- Kanan: Search -->
                        <form action="{{ route('category.index') }}" method="GET" class="flex items-center max-w-sm">
                    ...
                    <div class="md:my-4 flex justify-center" id="categoriesTable">
                        {{ $categories->links() }}
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                text: "Data yang berhubungan dengan kategori ini akan ikut dihapus. Data tidak dapat dikembalikan!",
                icon: 'warning',
